...
if __name__ == '__main__':
    ...
    g = StyleGANv2Generator(1024, 512, pretrained=dict(
        ckpt_path="./work_dirs/pre-trained/stylegan2_c2_ffhq_1024_b4x8_20210407_150045-618c9024.pth",prefix='generator'))
